import {Box, Collapse, Link, List, ListItem, ListItemIcon, ListItemText, SvgIcon, Typography} from "@material-ui/core";
        ...
        <List component="nav" aria-label="main mailbox folders">
            ...
            <ListItem button>
                ...
                <ListItemText onClick={() => window.open(telegramChat)}>
                    <Typography component={"span"} display={"inline"}>Telegram</Typography>
