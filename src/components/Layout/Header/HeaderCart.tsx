...
export default function HeaderCart() {
    ...
    function calcCartSize() {
        return cartStore.getState().selectedProducts
    ...
    return (<>
        <IconButton className={classes.cart} size={'medium'} onClick={handleClickOpen}>
            <StyledBadge max={9} badgeContent={cartSize}>
                <ShoppingCartTwoToneIcon fontSize={'large'}/>
            </StyledBadge>
        </IconButton>
        <Dialog scroll={isSmallScreen ? 'body' : 'paper'}
            ...
            <CustomAppBar>
                <Toolbar className={"flex justify-between"}>
                    ...
                    <IconButton edge="start" className={classes.closeButton} onClick={handleClose} aria-label="close-cart-window">
