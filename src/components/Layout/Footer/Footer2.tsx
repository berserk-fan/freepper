                    ...
                    <Container disableGutters>
                        <Grid container spacing={4}>
                            <Grid item xs={12} md={4} lg={3}>
                                ...
                                >
                                    <Image width={280} height={280} src={"/logo-512x512.png"} alt={"Логотип бренда Погладить можно?"} />
                                </Box>
                                ...
                                <Grid container spacing={2}>
                                    ...
                                    <Grid item xs={6} sm={4}>
                                        <CategoryProvider useStyles={useMagCategoryMenuStyles}>
                                            ...
                                            <CategoryItem>
                                                <Typography onClick={() => setContactsOpen(true)}>Контакты</Typography>
                                            </CategoryItem>
                        ...
                        >
                            <Item grow ml={-2} shrink={0}>
                                <NavMenu useStyles={usePlainNavigationMenuStyles}>
                                    <ColumnToRow at={'sm'}>
                                        {[supportPages.cooperation, supportPages["privacy-policy"]].map(page => (
