...
function toFiller(p: Product): string {
    switch(p.modelName as ProductKey) {
        case "chemodan": return "Холлофайбер, Синтепон";
        case "kvadroSoft": return "Холлофайбер";
        case "kvadroStrong": return "Холлофайбер";
        case "lukoshkoDuo": return "Холлофайбер";
        case "lukoshkoTrio": return "Холлофайбер";
        default: throw new Error('unmatched product id' + p.id)
    }
}

function toMartindale(p: Product): string {
    switch(p.modelName as ProductKey) {
        case "chemodan": return "50000 циклов";
        case "kvadroSoft": return "30000 циклов";
        case "kvadroStrong": return "50000 циклов";
        case "lukoshkoDuo": return "30000 циклов";
        case "lukoshkoTrio": return "30000 циклов";
        default: throw new Error('unmatched product id' + p.id)
    }
}
...
function toDensity(p: Product): string | null {
    switch(p.modelName as ProductKey) {
        case "chemodan": return "370 г/м2";
        case "kvadroSoft": return null;
        case "kvadroStrong": return "370г/м2";
        case "lukoshkoDuo": return null;
        case "lukoshkoTrio": return null;
        default: throw new Error('unmatched product id' + p.id)
    }
}
...
function toColourDefense(p: Product): string {
    switch(p.modelName as ProductKey) {
        case "chemodan": return "5/5";
        case "kvadroSoft": return "4/5";
        case "kvadroStrong": return "5/5";
        case "lukoshkoDuo": return "4/5";
        case "lukoshkoTrio": return "4/5";
        default: throw new Error('unmatched product id' + p.id)
    }
}
...
function waterResistance(p: Product): string {
    switch(p.modelName as ProductKey) {
        case "chemodan": return "да";
        case "kvadroSoft": return "медленное впитывание";
        case "kvadroStrong": return "да";
        case "lukoshkoDuo": return "медленное впитывание";
        case "lukoshkoTrio": return "медленное впитывание";
        default: throw new Error('unmatched product id' + p.id)
    }
}
...
function toOffer(p: Product): ElementCompact | undefined {
    ...
    let size = p.details.dogBed.sizes.find(x => x.id == p.details.dogBed.sizeId);
