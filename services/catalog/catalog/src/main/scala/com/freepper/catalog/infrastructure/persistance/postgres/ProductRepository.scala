...
import com.freepper.catalog.domain.product.{Product, ProductId, ProductRepository, ProductSelector, *}
import com.freepper.catalog.domain.product
import com.freepper.common.domain.{TypeName, crud}
import com.freepper.common.domain.crud.Crud.CrudName
...
//      QueryHelpers
//        .defaultUpdateRaw(Generic[UpdateProduct].to(req), req.id, updaterPoly, "products")
//        .toList
//        .map(_.update)
//    }
