  ...
  models: [
    {
      ...
      displayName: "Лукошко",
      description:
        "Очень хорошая лежанка сделанная из качественных материалов.",
...
export function getModelIndex(model: Model): ModelIndex {
  ...
  let entries: [string, Product[]][] = Object.entries(
    groupBy(products, (item) => item.color.id)
  );
